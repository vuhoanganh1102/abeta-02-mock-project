...
export class Migrations1716516168787 implements MigrationInterface {
    name = 'Migrations1716516168787'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`request\` (\`id\` bigint UNSIGNED NOT NULL AUTO_INCREMENT, \`title\` varchar(255) NOT NULL, \`content\` varchar(1000) NOT NULL, \`check_in\` timestamp NULL, \`check_out\` timestamp NULL, \`attendance_id\` bigint UNSIGNED NOT NULL, \`image_url\` varchar(255) NULL, \`status\` tinyint UNSIGNED NOT NULL DEFAULT '0', \`deleted_at\` datetime(6) NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`attendance\` (\`id\` bigint UNSIGNED NOT NULL AUTO_INCREMENT, \`user_id\` bigint UNSIGNED NOT NULL, \`date\` date NOT NULL, \`check_in\` timestamp NULL, \`check_out\` timestamp NULL, \`work_hours\` float NULL, \`late_time\` float NULL, \`status\` int UNSIGNED NOT NULL COMMENT '1: active, 0: deleted, 2: pending, 3: reject' DEFAULT '1', \`deleted_at\` datetime(6) NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`email_otp\` (\`id\` bigint UNSIGNED NOT NULL AUTO_INCREMENT, \`user_id\` bigint UNSIGNED NOT NULL, \`user_email\` varchar(255) NOT NULL, \`otp\` varchar(500) NOT NULL, \`otp_category\` tinyint NOT NULL COMMENT '1: verify otp, 2: reset password otp', \`is_current\` tinyint NOT NULL DEFAULT '1', \`expired_at\` datetime NOT NULL, \`deleted_at\` datetime(6) NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`user_notification\` (\`id\` bigint UNSIGNED NOT NULL AUTO_INCREMENT, \`user_id\` bigint UNSIGNED NOT NULL, \`notification_id\` bigint UNSIGNED NOT NULL, \`is_read\` tinyint UNSIGNED NOT NULL DEFAULT '0', \`deleted_at\` datetime(6) NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`notification\` (\`id\` bigint UNSIGNED NOT NULL AUTO_INCREMENT, \`title\` varchar(255) NOT NULL, \`content\` varchar(1000) NOT NULL, \`admin_id\` bigint UNSIGNED NOT NULL, \`schedule_time\` datetime NOT NULL, \`deleted_at\` datetime(6) NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`request_admin\` (\`id\` bigint UNSIGNED NOT NULL AUTO_INCREMENT, \`request_id\` bigint UNSIGNED NOT NULL, \`admin_id\` bigint UNSIGNED NOT NULL, \`deleted_at\` datetime(6) NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`REL_5c6904300753ccfd06ea80acf3\` (\`request_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`company_config\` (\`id\` bigint UNSIGNED NOT NULL AUTO_INCREMENT, \`morning_start_time\` timestamp NULL, \`morning_end_time\` timestamp NULL, \`afternoon_start_time\` timestamp NULL, \`afternoon_end_time\` timestamp NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`ALTER TABLE \`request\` ADD CONSTRAINT \`FK_132251cae1dbf605da82830f5f9\` FOREIGN KEY (\`attendance_id\`) REFERENCES \`attendance\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`request_admin\` ADD CONSTRAINT \`FK_5c6904300753ccfd06ea80acf37\` FOREIGN KEY (\`request_id\`) REFERENCES \`request\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`request_admin\` ADD CONSTRAINT \`FK_91aa2436d98705dd0dc6addcddd\` FOREIGN KEY (\`admin_id\`) REFERENCES \`admin\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`request_admin\` DROP FOREIGN KEY \`FK_91aa2436d98705dd0dc6addcddd\``);
        await queryRunner.query(`ALTER TABLE \`request_admin\` DROP FOREIGN KEY \`FK_5c6904300753ccfd06ea80acf37\``);
        ...
        await queryRunner.query(`ALTER TABLE \`request\` DROP FOREIGN KEY \`FK_132251cae1dbf605da82830f5f9\``);
        ...
        await queryRunner.query(`DROP INDEX \`REL_5c6904300753ccfd06ea80acf3\` ON \`request_admin\``);
