...
export class Migrations1716275708096 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`company_config\` (\`id\` bigint UNSIGNED NOT NULL AUTO_INCREMENT, \`morning_start_time\` timestamp NOT NULL, \`morning_end_time\` timestamp NOT NULL, \`afternoon_start_time\` timestamp NOT NULL, \`afternoon_end_time\` timestamp NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
